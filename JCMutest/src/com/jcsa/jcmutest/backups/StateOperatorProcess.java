...
public abstract class StateOperatorProcess {
	...
	private StateMutation state_mutation;
	
	/* constructor */
	protected StateOperatorProcess() { }
	...
	public boolean generate_infections(AstMutation mutation, 
		...
		this.state_mutation = state_mutation;
	...
	protected boolean add_infection(SecConstraint constraint, SecStateError init_error) throws Exception {
		this.state_mutation.add_state_pair(constraint, init_error); return true;
	}
	/**
	...
	protected boolean report_equivalence_mutation() throws Exception {
		throw new UnsupportedOperationException("Equivalent mutation: " + this.state_mutation.get_mutation());
	}
