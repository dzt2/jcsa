...
public class SecBitwsAndRPropagator extends SecExpressionPropagator {
	...
	protected void propagate_set_expression(SecSetExpressionError error) throws Exception {
		...
		SymExpression muta_expression = SymFactory.bitws_and(type, loperand, roperand);
	...
	protected void propagate_add_expression(SecAddExpressionError error) throws Exception {
		...
		case bit_and:
		{
			target_error = this.add_expression(COperator.bit_and, add_operand);
			break;
		}
		case bit_or:
		{
