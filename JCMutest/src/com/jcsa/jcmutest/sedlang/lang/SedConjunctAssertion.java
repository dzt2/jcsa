...
/**
 * conjunct_assertion |-- assertion (&& assertion)+
 * @author yukimula
 *
 */
public class SedConjunctAssertion extends SedAssertion {
	
	/* definition */
	protected SedConjunctAssertion() {
		super(null);
	}
	/**
	...
	protected SedNode copy_self() {
		return new SedConjunctAssertion();
	}
	@Override
