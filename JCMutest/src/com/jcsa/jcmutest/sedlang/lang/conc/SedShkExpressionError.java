...
public class SedShkExpressionError extends SedUnyExpressionError {

	public SedShkExpressionError(CirStatement statement, CirExpression orig_expression)
			throws Exception {
		super(statement, SedKeywords.shk_expr, orig_expression);
	}
	...
	protected SedNode construct() throws Exception {
		return new SedShkExpressionError(
