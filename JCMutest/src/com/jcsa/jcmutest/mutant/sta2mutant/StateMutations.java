...
/**
 * 	It provides the domain-values for defining abstract execution states.
 * 	
 * 	@author yukimula
 *
 */
public final class StateMutations {
	...
	/**
	 * @param source
	 * @return whether the source is an expression of trap_value
	 */
	...
	/**
	 * @param source
	 * @return whether the source is any abstract value defined
	 */
	...
	/**
	 * @param expression
	 * @return whether the expression contains abstract value
	 */
	 ...
	 * @param in_context
	 * @param ou_context
	 * @return trap_value if arithmetic invalid operation arises
	 * @throws Exception
	 */
