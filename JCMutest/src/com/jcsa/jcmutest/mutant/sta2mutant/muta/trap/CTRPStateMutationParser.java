...
public class CTRPStateMutationParser extends StateMutationParser {
	...
	protected void generate_infections(AstMutation mutation) throws Exception {
		...
		CirConditionState constraint = CirAbstractState.eva_cond(execution, c_case.get_condition(), true);
