...
public class StateArithMulParser extends StateOperatorParser {
	...
	protected boolean arith_div() throws Exception {
		 ...
		 * **/
		Collection<Object> expressions = new HashSet<Object>();
		expressions.add(this.sym_expression(COperator.
				not_equals, this.loperand, Integer.valueOf(0)));
		expressions.add(this.sym_expression(COperator.
				not_equals, this.roperand, Integer.valueOf(1)));
		expressions.add(this.sym_expression(COperator.
				not_equals, this.roperand, Integer.valueOf(-1)));
		SymbolExpression condition = this.sym_conjunction(expressions);
