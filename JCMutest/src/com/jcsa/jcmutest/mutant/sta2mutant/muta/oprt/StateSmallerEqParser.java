...
public class StateSmallerEqParser extends StateOperatorParser {
	...
	protected boolean arith_sub() throws Exception {
		...
		expressions.add(this.sym_expression(COperator.greater_eq, this.loperand, this.roperand));
	...
	protected boolean arith_div() throws Exception {
		...
		expressions.add(this.sym_expression(COperator.greater_tn, this.loperand, this.roperand));
		SymbolExpression condition = this.sym_conjunction(expressions);
	...
	protected boolean greater_eq() throws Exception {
		 ...
		 * 	[E]	{x <= y -> x >= y}
		 * **/
		SymbolExpression condition = this.sym_expression(COperator.not_equals, this.loperand, this.roperand);
	...
	protected boolean smaller_tn() throws Exception {
		 ...
		 * 	[E]	{x <= y -> FALSE}
		 * **/
		SymbolExpression condition = this.sym_expression(COperator.equal_with, this.loperand, this.roperand);
	...
	protected boolean equal_with() throws Exception {
		 ...
		 * 	[E]	{x <= y -> FALSE}
		 * **/
		SymbolExpression condition = this.sym_expression(COperator.smaller_tn, this.loperand, this.roperand);
		return this.parse_by_condition_and_muvalue(condition, Boolean.FALSE);
	}
	...
	protected boolean not_equals() throws Exception {
		 ...
		 * 	[E]	{x <= y -> x != y}
		 * **/
		SymbolExpression condition = this.sym_expression(COperator.greater_eq, this.loperand, this.roperand);
