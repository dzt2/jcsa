...
public class CirSetBitwsIorParser extends CirOperatorParser {

	@Override
	protected boolean to_assign() throws Exception {
		/** mutation [x | y; y] :: (x & y != x) **/
		CirAttribute constraint, init_error;
		SymbolExpression condition, muta_expression;
		
		condition = this.sym_expression(COperator.bit_and, this.loperand, this.roperand);
		constraint = this.get_constraint(SymbolFactory.not_equals(condition, this.loperand));
	...
	protected boolean bitws_lsh() throws Exception {
		...
		constraint = this.get_constraint(SymbolFactory.not_equals(this.roperand, 0));
