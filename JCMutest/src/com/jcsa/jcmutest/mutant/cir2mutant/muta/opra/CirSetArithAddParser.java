...
/**
 * It replaces the arithmetic add operator to other.
 * 
 * @author yukimula
 *
 */
public class CirSetArithAddParser extends CirOperatorParser {
	...
	protected boolean arith_mod() throws Exception {
		...
		CirAttribute constraint = this.get_constraint(SymbolFactory.not_equals(
				this.sym_expression(COperator.arith_add, this.loperand, this.roperand), 
				Integer.valueOf(0)));
	...
	protected boolean bitws_ior() throws Exception {
		/** constraint: {x + y --> x | y} ==> {x & y != 0} **/
		CirAttribute constraint = this.get_constraint(SymbolFactory.not_equals(
				this.sym_expression(COperator.bit_and, this.loperand, this.roperand), 
				Integer.valueOf(0)));
	...
	protected boolean logic_ior() throws Exception {
		...
		/** constraint: {x + y --> x || y} ==> {either x or y be non_bool} **/
