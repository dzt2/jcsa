...
public class CirSetArithAddParser extends CirSetOperatorParser {
	...
	protected boolean arith_mod() throws Exception {
		 ...
		 * 	[x < -y || x > -2y] --> set_expr
		 */
		SymCondition constraint; SymCondition init_error; SymbolExpression condition, operand;
		List<SymCondition> constraints = new ArrayList<SymCondition>();
		if(this.compare_or_mutate) {
	...
	protected boolean logic_ior() throws Exception {
		 ...
		 * 	[x != AnyBool || y != AnyBool]
		 */
		SymCondition constraint; SymCondition init_error; SymbolExpression operand;
		List<SymCondition> constraints = new ArrayList<SymCondition>();
