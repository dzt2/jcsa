...
public class VBRPCirMutationParser extends CirMutationParser {
	...
	protected void generate_infections(CirTree cir_tree, CirStatement statement, AstMutation mutation,
		...
		case set_true: 	
		{
			constraint = CirMutations.eva_expr(execution, SymbolFactory.sym_condition(expression, false));
		...
		case set_false:	
		{
			constraint = CirMutations.eva_expr(execution, SymbolFactory.sym_condition(expression, true));
