...
public class CirSetBitwsRshParser extends CirOperatorParser {
	...
	protected boolean arith_mod() throws Exception {
		...
		CirAttribute constraint, init_error;
		constraint = this.get_constraint(SymbolFactory.not_equals(loperand, 0));
		init_error = this.mut_expression(this.sym_expression(COperator.arith_mod, loperand, roperand));
		return this.add_infection(constraint, init_error);
	}
	...
	protected boolean bitws_xor() throws Exception {
		...
		constraint = this.get_constraint(SymbolFactory.not_equals(roperand, 0));
