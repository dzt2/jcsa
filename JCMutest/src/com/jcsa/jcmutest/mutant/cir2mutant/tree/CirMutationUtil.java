...
/**
 * It is used to construct CirMutationTree from root recursively.
 * 
 * @author yukimula
 *
 */
class CirMutationUtil {
	...
	/* singleton */	/** constructors **/ private CirMutationUtil() { }
	private static final CirMutationUtil util = new CirMutationUtil();
	
	/* basic methods */
	/** the dependence graph used to perform data flow and control analysis **/
	private CDependGraph dependence_graph;
	/**
	...
	/* construction */
	/**
	 * recursively construct the tree from specified parent
	 * @param parent
	 * @throws Exception
	 */
	private void construct_from(CirMutationNode parent) throws Exception {
		if(parent == null) {
			throw new IllegalArgumentException("Invalid parent: null");
		}
		else {
			throw new IllegalArgumentException("Unsupport: " + parent.toString());
		}
	}
	
	/* ast_kill --> cir_kill */
	private void construct_ast_kill(CirMutationNode parent) throws Exception {
