package com.jcsa.jcmutest.mutant.sec2mutant.mut.proc;
...
import com.jcsa.jcmutest.mutant.sec2mutant.mut.StateOperatorProcess;
...
public class StateArithAddProcess extends StateOperatorProcess {
	...
	protected boolean arith_mod() throws Exception {
		 ...
		 * 	[x < -y || x > -2y] --> set_expr
		 */
		SecConstraint constraint; SecStateError init_error; SymExpression condition, operand;
		List<SecConstraint> constraints = new ArrayList<SecConstraint>();
		if(this.compare_or_mutate) {
	...
	protected boolean logic_ior() throws Exception {
		 ...
		 * 	[x != AnyBool || y != AnyBool]
		 */
		SecConstraint constraint; SecStateError init_error; SymExpression operand;
		List<SecConstraint> constraints = new ArrayList<SecConstraint>();
