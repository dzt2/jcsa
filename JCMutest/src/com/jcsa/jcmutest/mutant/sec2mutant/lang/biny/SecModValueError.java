...
public class SecModValueError extends SecBinaryValueError {

	public SecModValueError(CirStatement statement, CirExpression orig_expression,
			SymExpression muta_expression) throws Exception {
		super(statement, SecKeywords.mod_value, orig_expression, muta_expression);
	}
