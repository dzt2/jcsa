...
public class SecIorValueError extends SecBinaryValueError {

	public SecIorValueError(CirStatement statement, CirExpression orig_expression,
			SymExpression muta_expression) throws Exception {
		super(statement, SecKeywords.ior_value, orig_expression, muta_expression);
	}
