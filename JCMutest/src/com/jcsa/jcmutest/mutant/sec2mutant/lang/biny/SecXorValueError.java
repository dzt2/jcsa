...
public class SecXorValueError extends SecBinaryValueError {

	public SecXorValueError(CirStatement statement, CirExpression orig_expression,
			SymExpression muta_expression) throws Exception {
		super(statement, SecKeywords.xor_value, orig_expression, muta_expression);
	}
