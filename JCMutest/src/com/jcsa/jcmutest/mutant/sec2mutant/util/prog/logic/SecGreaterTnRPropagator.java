...
public class SecGreaterTnRPropagator extends SecExpressionPropagator {
	...
	protected void propagate_set_expression(SecSetExpressionError error) throws Exception {
		...
		SymExpression muta_expression = SymFactory.smaller_tn(roperand, loperand);
	...
	protected void propagate_add_expression(SecAddExpressionError error) throws Exception {
		...
		case arith_add:
		{
			...
			muta_expression = SymFactory.smaller_tn(roperand, loperand);
