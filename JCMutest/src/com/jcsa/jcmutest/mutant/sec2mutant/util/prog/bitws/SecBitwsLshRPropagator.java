...
public class SecBitwsLshRPropagator extends SecExpressionPropagator {
	...
	protected void propagate_set_expression(SecSetExpressionError error) throws Exception {
		...
		SymExpression muta_expression = SymFactory.bitws_lsh(type, loperand, roperand);
	...
	protected void propagate_add_expression(SecAddExpressionError error) throws Exception {
		...
		case arith_add:
		{
			target_error = this.add_expression(COperator.left_shift, add_operand);
			break;
		}
		case arith_sub:
		{
