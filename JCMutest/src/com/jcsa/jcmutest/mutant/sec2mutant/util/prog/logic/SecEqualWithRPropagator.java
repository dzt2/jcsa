...
public class SecEqualWithRPropagator extends SecExpressionPropagator {
	...
	protected void propagate_set_expression(SecSetExpressionError error) throws Exception {
		...
		SymExpression muta_expression = SymFactory.equal_with(loperand, roperand);
	...
	protected void propagate_add_expression(SecAddExpressionError error) throws Exception {
		...
		case arith_add:
		{
			...
			muta_expression = SymFactory.equal_with(loperand, roperand);
