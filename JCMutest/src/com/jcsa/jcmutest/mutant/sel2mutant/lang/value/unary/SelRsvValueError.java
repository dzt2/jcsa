...
public class SelRsvValueError extends SelUnaryValueError {

	public SelRsvValueError(CirStatement statement, CirExpression orig_expression)
			throws Exception {
		super(statement, SelKeywords.rsv_value, orig_expression);
	}
