...
public class SelModValueError extends SelBinaryValueError {

	public SelModValueError(CirStatement statement, CirExpression orig_expression,
			SymExpression muta_expression) throws Exception {
		super(statement, SelKeywords.mod_value, orig_expression, muta_expression);
	}
