...
public class SedAndExpressionError extends SedConBinExpressionError {

	protected SedAndExpressionError(CirStatement statement, 
	...
	protected String generate_content() throws Exception {
		return "and_" + this.get_orig_type().toString() + "("
