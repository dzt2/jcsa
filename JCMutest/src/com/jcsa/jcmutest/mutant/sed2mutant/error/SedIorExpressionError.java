...
public class SedIorExpressionError extends SedConBinExpressionError {

	protected SedIorExpressionError(CirStatement statement, 
	...
	protected String generate_content() throws Exception {
		return "ior_" + this.get_orig_type().toString() + "("
