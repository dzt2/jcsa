...
public class SedAddRealExpressionError extends SedRealExpressionError {

	public SedAddRealExpressionError(CirStatement location, 
	...
	protected SedNode clone_self() {
		return new SedAddRealExpressionError(
