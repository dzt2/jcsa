...
public class SedSetBooleanError extends SedAbsBinaryValueError {

	public SedSetBooleanError(CirStatement location, 
	...
	public String generate_content() throws Exception {
		return "set_bool(" + this.get_orig_expression().generate_code()
				+ ", " + this.get_muta_expression().generate_code() + ")";
	}

	@Override
	protected SedNode clone_self() {
		return new SedSetBooleanError(get_location().get_cir_statement(),
