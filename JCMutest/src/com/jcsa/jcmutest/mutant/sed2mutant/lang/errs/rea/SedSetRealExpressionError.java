...
public class SedSetRealExpressionError extends SedRealExpressionError {

	public SedSetRealExpressionError(CirStatement location, 
	...
	protected SedNode clone_self() {
		return new SedSetRealExpressionError(
