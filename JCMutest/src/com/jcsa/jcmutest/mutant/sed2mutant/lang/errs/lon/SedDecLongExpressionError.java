...
public class SedDecLongExpressionError extends SedLongExpressionError {

	public SedDecLongExpressionError(CirStatement 
	...
	protected SedNode clone_self() {
		return new SedDecLongExpressionError(
