...
public class SedChgCharExpressionError extends SedCharExpressionError {

	public SedChgCharExpressionError(CirStatement location, SedExpression orig_expression) {
	...
	protected SedNode clone_self() {
		return new SedChgCharExpressionError(
