...
public class SedSetByteExpressionError extends SedByteExpressionError {

	public SedSetByteExpressionError(CirStatement location, 
	...
	protected String generate_content() throws Exception {
		return "set_byte(" + this.get_orig_expression().generate_code()
				+ ", " + this.get_muta_expression().generate_code() + ")";
	}

	@Override
	protected SedNode clone_self() {
		return new SedSetByteExpressionError(
