...
public class SedAddLongExpressionError extends SedLongExpressionError {

	public SedAddLongExpressionError(CirStatement location, 
	...
	protected SedNode clone_self() {
		return new SedAddLongExpressionError(
