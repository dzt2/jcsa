...
public class SedSetIntegerError extends SedAbsBinaryValueError {

	public SedSetIntegerError(CirStatement location, 
	...
	protected SedNode clone_self() {
		return new SedSetIntegerError(get_location().get_cir_statement(),
