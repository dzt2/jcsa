...
public class SedMulRealExpressionError extends SedRealExpressionError {

	public SedMulRealExpressionError(CirStatement location, 
	...
	protected SedNode clone_self() {
		return new SedMulRealExpressionError(
