...
public class SedIorLongExpressionError extends SedLongExpressionError {

	public SedIorLongExpressionError(CirStatement location, 
	...
	protected SedNode clone_self() {
		return new SedIorLongExpressionError(
