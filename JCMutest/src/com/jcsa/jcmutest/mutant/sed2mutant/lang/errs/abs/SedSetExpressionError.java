...
/**
 * set_expr(orig_expr, muta_expr): orig_expr --> muta_expr
 * @author yukimula
 *
 */
public class SedSetExpressionError extends SedAbstExpressionError {
	...
	protected SedNode clone_self() {
		return new SedSetExpressionError(get_location().get_cir_statement(),
