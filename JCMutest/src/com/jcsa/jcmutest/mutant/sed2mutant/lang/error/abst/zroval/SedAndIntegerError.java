...
public class SedAndIntegerError extends SedAbsBinaryValueError {

	public SedAndIntegerError(CirStatement location, SedExpression 
	...
	public String generate_content() throws Exception {
		return "and_long(" + this.get_orig_expression().generate_code()
				+ ", " + this.get_muta_expression().generate_code() + ")";
	}

	@Override
	protected SedNode clone_self() {
		return new SedAndIntegerError(get_location().get_cir_statement(),
