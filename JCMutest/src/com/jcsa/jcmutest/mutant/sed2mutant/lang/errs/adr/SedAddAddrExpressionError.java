...
public class SedAddAddrExpressionError extends SedAddrExpressionError {

	public SedAddAddrExpressionError(CirStatement location, 
	...
	protected SedNode clone_self() {
		return new SedAddAddrExpressionError(
