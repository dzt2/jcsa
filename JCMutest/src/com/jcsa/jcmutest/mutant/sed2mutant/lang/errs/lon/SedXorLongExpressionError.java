...
public class SedXorLongExpressionError extends SedLongExpressionError {

	public SedXorLongExpressionError(CirStatement location, 
	...
	protected SedNode clone_self() {
		return new SedXorLongExpressionError(
