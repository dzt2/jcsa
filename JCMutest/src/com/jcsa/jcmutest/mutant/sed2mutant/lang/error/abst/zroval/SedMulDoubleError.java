...
public class SedMulDoubleError extends SedAbsBinaryValueError {

	public SedMulDoubleError(CirStatement location, SedExpression 
	...
	public String generate_content() throws Exception {
		return "mul_real(" + this.get_orig_expression().generate_code()
				+ ", " + this.get_muta_expression().generate_code() + ")";
	}

	@Override
	protected SedNode clone_self() {
		return new SedMulDoubleError(get_location().get_cir_statement(),
