...
public class SedSetAddrExpressionError extends SedAddrExpressionError {

	public SedSetAddrExpressionError(CirStatement location, 
	...
	protected SedNode clone_self() {
		return new SedSetAddrExpressionError(
