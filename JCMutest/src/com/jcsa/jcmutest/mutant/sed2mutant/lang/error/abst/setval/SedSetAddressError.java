...
public class SedSetAddressError extends SedAbsBinaryValueError {

	public SedSetAddressError(CirStatement location, 
	...
	public String generate_content() throws Exception {
		return "set_addr(" + this.get_orig_expression().generate_code()
				+ ", " + this.get_muta_expression().generate_code() + ")";
	}

	@Override
	protected SedNode clone_self() {
		return new SedSetAddressError(get_location().get_cir_statement(),
