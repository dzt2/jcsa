...
public class SedIncIntegerError extends SedAbsUnaryValueError {

	public SedIncIntegerError(CirStatement location, 
	...
	public String generate_content() throws Exception {
		return "inc_long(" + this.get_orig_expression().generate_code() + ")";
	}

	@Override
	protected SedNode clone_self() {
		return new SedIncIntegerError(this.get_location().
