...
public class SedSetBoolExpressionError extends SedBoolExpressionError {

	public SedSetBoolExpressionError(CirStatement location, 
	...
	protected SedNode clone_self() {
		return new SedSetBoolExpressionError(
