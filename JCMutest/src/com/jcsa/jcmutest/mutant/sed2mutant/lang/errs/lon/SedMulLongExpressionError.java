...
public class SedMulLongExpressionError extends SedLongExpressionError {

	public SedMulLongExpressionError(CirStatement location, 
	...
	protected SedNode clone_self() {
		return new SedMulLongExpressionError(
