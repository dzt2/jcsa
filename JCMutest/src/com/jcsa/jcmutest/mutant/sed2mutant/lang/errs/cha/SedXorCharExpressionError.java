...
public class SedXorCharExpressionError extends SedCharExpressionError {

	public SedXorCharExpressionError(CirStatement location, 
	...
	protected String generate_content() throws Exception {
		return "xor_char(" + this.get_orig_expression().generate_code() + 
				", " + this.get_muta_expression().generate_code() + ")";
	}

	@Override
	protected SedNode clone_self() {
		return new SedXorCharExpressionError(
