...
public class SedAndLongExpressionError extends SedLongExpressionError {

	public SedAndLongExpressionError(CirStatement location, 
	...
	protected SedNode clone_self() {
		return new SedAndLongExpressionError(
