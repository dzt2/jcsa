...
public class SedAddCharExpressionError extends SedCharExpressionError {

	public SedAddCharExpressionError(CirStatement location, 
	...
	protected SedNode clone_self() {
		return new SedAddCharExpressionError(
