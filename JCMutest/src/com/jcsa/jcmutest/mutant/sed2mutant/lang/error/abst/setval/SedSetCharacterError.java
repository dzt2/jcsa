...
public class SedSetCharacterError extends SedAbsBinaryValueError {

	public SedSetCharacterError(CirStatement location, 
	...
	protected SedNode clone_self() {
		return new SedSetCharacterError(get_location().get_cir_statement(),
