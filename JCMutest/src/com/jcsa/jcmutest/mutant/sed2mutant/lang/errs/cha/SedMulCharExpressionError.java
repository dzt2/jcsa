...
public class SedMulCharExpressionError extends SedCharExpressionError {

	public SedMulCharExpressionError(CirStatement location, 
	...
	protected String generate_content() throws Exception {
		return "mul_char(" + this.get_orig_expression().generate_code() + 
				", " + this.get_muta_expression().generate_code() + ")";
	}

	@Override
	protected SedNode clone_self() {
		return new SedMulCharExpressionError(
