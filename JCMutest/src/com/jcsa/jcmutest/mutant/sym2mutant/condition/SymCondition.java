...
public class SymCondition {
	...
	/**
	 * @param expression
	 * @return observation:mut_expr(expression.execution, expression, null)
	 * @throws Exception
	 */
	protected static SymCondition mut_expr(CirExpression expression) throws Exception {
		if(expression == null || expression.statement_of() == null) {
			throw new IllegalArgumentException("Invalid expression: " + expression);
		}
		else {
	...
	/**
	 * @param expression
	 * @return observation:mut_refr(expression.execution, expression, null)
	 * @throws Exception
	 */
	protected static SymCondition mut_refr(CirExpression expression) throws Exception {
		if(expression == null || expression.statement_of() == null) {
			throw new IllegalArgumentException("Invalid expression: " + expression);
		}
		else {
	 ...
	 * @throws Exception
	 */
	protected static SymCondition mut_stat(CirExpression expression) throws Exception {
		if(expression == null || expression.statement_of() == null) {
			throw new IllegalArgumentException("Invalid expression: " + expression);
		}
		else {
	 ...
	 * @throws Exception
	 */
	private static boolean is_nonauto(CirExpression expression) throws Exception {
	 ...
	 * @throws Exception
	 */
	private static CirExecution execution_of(CirNode node) throws Exception {
		while(node != null) {
