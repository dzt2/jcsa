...
public class CirAssignXorMutationParser extends CirOperatorMutationParser {
	...
	protected boolean arith_sub() throws Exception {
		...
		ovalue = this.sym_expression(COperator.bit_xor, this.get_loperand(), this.get_roperand());
	...
	protected boolean arith_mul() throws Exception {
		SymbolExpression ovalue, mvalue;
		ovalue = this.sym_expression(COperator.bit_xor, this.get_loperand(), this.get_roperand());
		mvalue = this.sym_expression(COperator.arith_mul, this.get_loperand(), this.get_roperand());
	...
	protected boolean arith_div() throws Exception {
		SymbolExpression ovalue, mvalue;
		ovalue = this.sym_expression(COperator.bit_xor, this.get_loperand(), this.get_roperand());
		mvalue = this.sym_expression(COperator.arith_div, this.get_loperand(), this.get_roperand());
	...
	protected boolean arith_mod() throws Exception {
		SymbolExpression ovalue, mvalue;
		ovalue = this.sym_expression(COperator.bit_xor, this.get_loperand(), this.get_roperand());
		mvalue = this.sym_expression(COperator.arith_mod, this.get_loperand(), this.get_roperand());
	...
	protected boolean bitws_and() throws Exception {
		SymbolExpression ovalue, mvalue;
		ovalue = this.sym_expression(COperator.bit_xor, this.get_loperand(), this.get_roperand());
		mvalue = this.sym_expression(COperator.bit_and, this.get_loperand(), this.get_roperand());
		return this.parse_by_condition_and_operator(this.neq_expression(ovalue, mvalue), COperator.bit_and_assign);
	}
	...
	@Override
	protected boolean bitws_xor() throws Exception { return this.report_equivalent_mutation(); }
	...
	protected boolean bitws_lsh() throws Exception {
		...
		SymbolExpression ovalue, mvalue;
		ovalue = this.sym_expression(COperator.bit_xor, this.get_loperand(), this.get_roperand());
		mvalue = this.sym_expression(COperator.left_shift, this.get_loperand(), this.get_roperand());
		conditions.add(this.neq_expression(ovalue, mvalue));
	...
	protected boolean bitws_rsh() throws Exception {
		...
		SymbolExpression ovalue, mvalue;
		ovalue = this.sym_expression(COperator.bit_xor, this.get_loperand(), this.get_roperand());
		mvalue = this.sym_expression(COperator.righ_shift, this.get_loperand(), this.get_roperand());
		conditions.add(this.neq_expression(ovalue, mvalue));
