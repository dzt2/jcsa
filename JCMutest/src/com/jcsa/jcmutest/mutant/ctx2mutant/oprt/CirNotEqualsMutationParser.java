...
public class CirNotEqualsMutationParser extends CirOperatorMutationParser {
	...
	@Override
	protected boolean arith_mod() throws Exception { return this.not_equals(); }
	...
	protected boolean greater_tn() throws Exception {
		SymbolExpression condition = this.sym_expression(
						COperator.smaller_tn, get_loperand(), get_roperand());
	...
	protected boolean greater_eq() throws Exception {
		SymbolExpression condition = this.
				sym_expression(COperator.smaller_eq, get_loperand(), get_roperand());
	...
	protected boolean smaller_tn() throws Exception {
		SymbolExpression condition = this.sym_expression(
						COperator.greater_tn, get_loperand(), get_roperand());
		return this.parse_by_condition_and_muvalue(condition, Boolean.FALSE);
	}
	...
	protected boolean smaller_eq() throws Exception {
		SymbolExpression condition = this.
				sym_expression(COperator.greater_eq, get_loperand(), get_roperand());
		return this.parse_by_condition_and_operator(condition, COperator.smaller_eq);
	}

	@Override
	protected boolean equal_with() throws Exception {
		return this.parse_by_condition_and_operator(Boolean.TRUE, COperator.equal_with);
	}

	@Override
	protected boolean not_equals() throws Exception { return this.report_equivalent_mutation(); }
