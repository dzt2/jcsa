...
public class CirAssignMulMutationParser extends CirOperatorMutationParser {

	@Override
	protected boolean arith_add() throws Exception {
		/** (x *= y; x += y) :: (x * y != x + y) --> (x += y) **/
		SymbolExpression loperand = this.sym_expression(COperator.arith_mul, get_loperand(), get_roperand());
	...
	protected boolean arith_mod() throws Exception {
		...
		List<Object> conditions = new ArrayList<Object>(); 
		conditions.add(this.neq_expression(this.get_loperand(), Integer.valueOf(0)));
		SymbolExpression loperand = this.sym_expression(COperator.arith_mul, this.get_loperand(), this.get_roperand());
	...
	protected boolean bitws_ior() throws Exception {
		...
		return this.parse_by_condition_and_operator(this.neq_expression(loperand, roperand), COperator.bit_or_assign);
	}
	...
	protected boolean bitws_xor() throws Exception {
		/** (x *= y; x ^= y) :: (x * y != x ^ y) --> (x ^= y) **/
		SymbolExpression loperand = this.sym_expression(COperator.arith_mul, this.get_loperand(), this.get_roperand());
		SymbolExpression roperand = this.sym_expression(COperator.bit_xor, this.get_loperand(), this.get_roperand());
