...
public class CirArithDivMutationParser extends CirOperatorMutationParser {
	...
	protected boolean greater_eq() throws Exception {
		...
		return this.parse_by_condition_and_operator(this.sym_conjunctions(conditions), COperator.greater_eq);
	}
	...
	protected boolean smaller_eq() throws Exception {
		...
		return this.parse_by_condition_and_operator(this.sym_conjunctions(conditions), COperator.smaller_eq);
	}
	...
	protected boolean equal_with() throws Exception {
		...
		List<Object> conditions = new ArrayList<Object>();
		conditions.add(this.neq_expression(this.get_loperand(), this.get_roperand()));
		conditions.add(this.dif_condition(this.sym_expression(COperator.equal_with, this.get_loperand(), this.get_roperand())));
		return this.parse_by_condition_and_operator(this.sym_conjunctions(conditions), COperator.equal_with);
	}

	@Override
	protected boolean not_equals() throws Exception { return this.parse_by_operator(COperator.equal_with); }
