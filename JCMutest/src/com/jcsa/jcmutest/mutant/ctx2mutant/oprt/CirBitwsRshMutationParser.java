...
public class CirBitwsRshMutationParser extends CirOperatorMutationParser {
	...
	protected boolean arith_add() throws Exception {
		...
		conditions.add(this.dif_condition(this.sym_expression(
					COperator.arith_add, this.get_loperand(), this.get_roperand())));
	...
	protected boolean arith_sub() throws Exception {
		...
		conditions.add(this.neq_expression(this.get_roperand(), Integer.valueOf(0)));
		conditions.add(this.dif_condition(this.sym_expression(
					COperator.arith_sub, this.get_loperand(), this.get_roperand())));
	...
	protected boolean arith_mul() throws Exception {
		...
		conditions.add(this.dif_condition(this.sym_expression(
					COperator.arith_mul, this.get_loperand(), this.get_roperand())));
	...
	protected boolean arith_div() throws Exception {
		...
		conditions.add(this.neq_expression(this.get_loperand(), Integer.valueOf(0)));
		conditions.add(this.dif_condition(this.sym_expression(
					COperator.arith_div, this.get_loperand(), this.get_roperand())));
	...
	protected boolean arith_mod() throws Exception {
		...
		conditions.add(this.neq_expression(this.get_loperand(), Integer.valueOf(0)));
		conditions.add(this.dif_condition(this.sym_expression(
					COperator.arith_mod, this.get_loperand(), this.get_roperand())));
	...
	protected boolean bitws_ior() throws Exception {
		...
		conditions.add(this.neq_expression(this.get_roperand(), Integer.valueOf(0)));
		conditions.add(this.dif_condition(this.sym_expression(
					COperator.bit_or, this.get_loperand(), this.get_roperand())));
	...
	protected boolean bitws_xor() throws Exception {
		...
		conditions.add(this.neq_expression(this.get_roperand(), Integer.valueOf(0)));
		conditions.add(this.dif_condition(this.sym_expression(
					COperator.bit_xor, this.get_loperand(), this.get_roperand())));
	...
	@Override
	protected boolean bitws_rsh() throws Exception { return this.report_equivalent_mutation(); }
