...
public class CirSmallerEqMutationParser extends CirOperatorMutationParser {
	...
	@Override
	protected boolean smaller_eq() throws Exception { return this.report_equivalent_mutation(); }
