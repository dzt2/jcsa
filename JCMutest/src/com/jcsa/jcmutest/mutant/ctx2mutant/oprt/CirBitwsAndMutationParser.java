...
public class CirBitwsAndMutationParser extends CirOperatorMutationParser {
	...
	protected boolean bitws_ior() throws Exception {
		/** (x & y; x | y) :: (x != y) --> (x | y) **/
		SymbolExpression condition = this.neq_expression(this.get_loperand(), this.get_roperand());
