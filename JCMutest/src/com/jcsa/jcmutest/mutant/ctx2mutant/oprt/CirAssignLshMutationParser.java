...
public class CirAssignLshMutationParser extends CirOperatorMutationParser {
	...
	protected boolean arith_add() throws Exception {
		...
		SymbolExpression ovalue = this.sym_expression(COperator.left_shift, this.get_loperand(), this.get_roperand());
