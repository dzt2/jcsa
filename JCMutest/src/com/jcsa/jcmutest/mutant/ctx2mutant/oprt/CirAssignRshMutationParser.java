...
public class CirAssignRshMutationParser extends CirOperatorMutationParser {
	...
	protected boolean arith_add() throws Exception {
		...
		SymbolExpression ovalue = this.sym_expression(COperator.righ_shift, this.get_loperand(), this.get_roperand());
	...
	protected boolean to_assign() throws Exception {
		/** (x >>= y; x = y) :: (x << y != y) --> (x = y) **/
		SymbolExpression ovalue = this.sym_expression(COperator.righ_shift, this.get_loperand(), this.get_roperand());
		SymbolExpression mvalue = this.sym_expression(this.get_roperand());
		return this.parse_by_condition_and_operator(this.neq_expression(ovalue, mvalue), COperator.assign);
	}
