...
public class CirSmallerTnMutationParser extends CirOperatorMutationParser {
	...
	protected boolean arith_mod() throws Exception {
		...
		conditions.add(this.sym_expression(COperator.greater_tn, this.get_loperand(), this.get_roperand()));
	...
	@Override
	protected boolean smaller_tn() throws Exception { return this.report_equivalent_mutation(); }

	@Override
	protected boolean smaller_eq() throws Exception {
		SymbolExpression condition = this.sym_expression(COperator.equal_with, get_loperand(), get_roperand());
		return this.parse_by_condition_and_muvalue(condition, Boolean.TRUE);
	}

	@Override
	protected boolean equal_with() throws Exception {
		SymbolExpression condition = this.sym_expression(COperator.smaller_eq, this.get_loperand(), this.get_roperand());
