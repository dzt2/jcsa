...
public class CirArithAddMutationParser extends CirOperatorMutationParser {
	...
	protected boolean to_assign() throws Exception {
		...
		SymbolExpression condition = this.sym_expression(
				COperator.not_equals, this.get_loperand(), 0);
		return this.parse_by_condition_and_operator(condition, COperator.assign);
	}

	@Override
	protected boolean arith_add() throws Exception { return this.report_equivalences(); }
	...
	protected boolean bitws_ior() throws Exception {
		...
		conditions.add(this.sym_expression(COperator.not_equals, 
				this.sym_expression(COperator.bit_and, this.get_loperand(), this.get_roperand()), 0));
