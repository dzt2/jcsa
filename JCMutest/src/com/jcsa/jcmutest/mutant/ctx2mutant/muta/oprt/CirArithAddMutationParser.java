...
public class CirArithAddMutationParser extends CirOperatorMutationParser {
	...
	@Override
	protected boolean arith_add() throws Exception { return this.parse_by_equivalence(); }
	...
	protected boolean bitws_ior() throws Exception {
		...
		conditions.add(this.sym_expression(COperator.not_equals, Integer.
				valueOf(0), this.sym_expression(COperator.bit_and, this.get_loperand(), this.get_roperand())));
	...
	protected boolean bitws_lsh() throws Exception {
		...
		SymbolExpression condition = this.sym_expression(
					COperator.not_equals, this.get_roperand(), Integer.valueOf(0));
