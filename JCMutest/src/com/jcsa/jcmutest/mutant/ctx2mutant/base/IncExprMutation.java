...
public class IncExprMutation extends ContextMutation {
	
	protected IncExprMutation(AstCirNode location, SymbolExpression loperand,
			SymbolExpression roperand) throws Exception {
		super(ContextMutaClass.inc_expr, location, loperand, roperand);
	}
