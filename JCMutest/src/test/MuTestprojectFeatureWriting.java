...
import com.jcsa.jcmutest.mutant.cir2mutant.tree.CirAttributeTreeWriter;
...
public class MuTestprojectFeatureWriting {
	...
	private static void testing(File root, boolean selected) throws Exception {
		...
		CirAttributeTreeWriter.write_features(code_file, output_directory, max_infecting_times, test_cases);
		//CirMutationsFeatureWriter.write_features(code_file, output_directory, max_infecting_times, test_cases);
		System.out.println();
	}
