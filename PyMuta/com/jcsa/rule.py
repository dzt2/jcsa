""" This file implements the model of killable prediction rules and mining algorithm. """
...
import com.jcsa.merd as jcenco
...
def main(project_directory: str, encoding_directory: str, output_directory: str):
	...
	start_flag, start_file_name = False, "calendar"
