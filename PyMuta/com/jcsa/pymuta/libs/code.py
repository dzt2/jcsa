"""This file implements the data model of program elements."""
...
class CProgram:
	"""
	It maintains the code file, abstract syntax tree, C-intermediate representative, control flow graph.
	"""
	...
	for fname in os.listdir(root_path):
		...
		for c_function in c_program.function_call_graph.get_functions():
			...
			for c_execution in c_function.get_executions():
				...
				print("\t\t", c_execution, ":\t", c_execution.get_statement().get_class_name(), '\t', c_execution.get_statement().get_cir_code())
