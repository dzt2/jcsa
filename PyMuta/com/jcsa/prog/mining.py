...
import com.jcsa.prog.feature as jcfeat
import pydotplus
...
class RIPMineContext:
	...
	def __init__(self, document: jcfeat.RIPDocument, exe_or_mut: bool, uk_or_cc: bool,
		...
		"""
		self.patterns = jcfeat.RIPPatterns(document, tests)
		self.solution = dict()
		# parameters
...
def do_frequent_mine(document: jcfeat.RIPDocument, tests, exe_or_mut: bool, uk_or_cc: bool, min_support: int,
...
def do_decision_mine(document: jcfeat.RIPDocument, tests, exe_or_mut: bool, uk_or_cc: bool, min_support: int,
					 min_confidence: float, max_confidence: float, max_length: int, output_directory: str):
	miner = RIPDTTMiner()
	context = RIPMineContext(document, exe_or_mut, uk_or_cc, min_support,
							 min_confidence, max_confidence, max_length, tests)
...
def testing(inputs_directory: str, output_directory: str, model_name: str,
	...
	for file_name in os.listdir(inputs_directory):
		...
		evaluation = jcmuta.MutationTestEvaluation(document.get_project())
		selected_mutants = evaluation.select_mutants_by_classes(["STRP", "BTRP"])
		selected_tests, _ = evaluation.select_tests_for_mutants(selected_mutants)
