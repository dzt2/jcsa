...
## TODO implement AstCirNode and AstCirTree as following...
...
if __name__ == "__main__":
	...
	for fname in os.listdir(root_path):
		...
		for asc_node in c_program.ast_cir_tree.get_nodes():
			print("{}[{}]\t{}\t{}[{}]\t{}".format(asc_node.child_type, asc_node.get_node_id(), asc_node.get_node_type(),
												  asc_node.get_ast_source().get_class_name(),
												  asc_node.get_ast_source().get_ast_id(), asc_node.get_token()))
		print()
