"""This file implements the expression-level mutation equivalence proof using z3 theorem prover."""
...
class SymbolToZ3Prover:
	"""
	It implements the proof of expression-level mutation equivalence.
	"""
	...
	def __solve__(self, state: jcmuta.ContextState):
		...
		elif state.get_category() == "inc_expr":
