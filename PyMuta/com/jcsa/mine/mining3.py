"""This file implements the pattern mining algorithms based on feature model from feature3.py"""
...
import com.jcsa.mine.feature3 as jcfeature
...
class RIPMineWriter:
	...
	def __write_pattern_head__(self, pattern: jcfeature.RIPPattern):
		...
		ur, ui, up, ki, uk, cc = pattern.counting(jcfeature.EX_SAMPLE_CLASS)
		self.__output__("\t\t{}\t{}\t{}\t{}\t{}\t{}\t{}\n".format("EXE", ur, ui, up, ki, uk, cc))
		ur, ui, up, ki, uk, cc = pattern.counting(jcfeature.SQ_SAMPLE_CLASS)
		self.__output__("\t\t{}\t{}\t{}\t{}\t{}\t{}\t{}\n".format("SEQ", ur, ui, up, ki, uk, cc))
		ur, ui, up, ki, uk, cc = pattern.counting(jcfeature.MU_SAMPLE_CLASS)
		...
		total, support, confidence = pattern.estimate(jcfeature.EX_SAMPLE_CLASS, jcfeature.unk_counted_support)
		self.__output__("\t\t{}\t{}\t{}\t{}\t{}\t{}\t{}\n".format("EXE", "UNK", total, support, total - support,
																  confidence, RIPMineWriter.__percentage__(confidence)))
		total, support, confidence = pattern.estimate(jcfeature.EX_SAMPLE_CLASS, jcfeature.wcc_counted_support)
		self.__output__("\t\t{}\t{}\t{}\t{}\t{}\t{}\t{}\n".format("EXE", "WCC", total, support, total - support,
																  confidence, RIPMineWriter.__percentage__(confidence)))
		total, support, confidence = pattern.estimate(jcfeature.EX_SAMPLE_CLASS, jcfeature.scc_counted_support)
		self.__output__("\t\t{}\t{}\t{}\t{}\t{}\t{}\t{}\n".format("EXE", "SCC", total, support, total - support,
																  confidence, RIPMineWriter.__percentage__(confidence)))
		# Estimate SEQ {UNK, WCC, SCC} total support negative confidence (%)
		total, support, confidence = pattern.estimate(jcfeature.SQ_SAMPLE_CLASS, jcfeature.unk_counted_support)
		self.__output__("\t\t{}\t{}\t{}\t{}\t{}\t{}\t{}\n".format("SEQ", "UNK", total, support, total - support,
																  confidence, RIPMineWriter.__percentage__(confidence)))
		total, support, confidence = pattern.estimate(jcfeature.SQ_SAMPLE_CLASS, jcfeature.wcc_counted_support)
		self.__output__("\t\t{}\t{}\t{}\t{}\t{}\t{}\t{}\n".format("SEQ", "WCC", total, support, total - support,
																  confidence, RIPMineWriter.__percentage__(confidence)))
		total, support, confidence = pattern.estimate(jcfeature.SQ_SAMPLE_CLASS, jcfeature.scc_counted_support)
		self.__output__("\t\t{}\t{}\t{}\t{}\t{}\t{}\t{}\n".format("SEQ", "SCC", total, support, total - support,
																  confidence, RIPMineWriter.__percentage__(confidence)))
		# Estimate MUT {UNK, WCC, SCC} total support negative confidence (%)
		total, support, confidence = pattern.estimate(jcfeature.MU_SAMPLE_CLASS, jcfeature.unk_counted_support)
		self.__output__("\t\t{}\t{}\t{}\t{}\t{}\t{}\t{}\n".format("MUT", "UNK", total, support, total - support,
																  confidence, RIPMineWriter.__percentage__(confidence)))
		total, support, confidence = pattern.estimate(jcfeature.MU_SAMPLE_CLASS, jcfeature.wcc_counted_support)
		self.__output__("\t\t{}\t{}\t{}\t{}\t{}\t{}\t{}\n".format("MUT", "WCC", total, support, total - support,
																  confidence, RIPMineWriter.__percentage__(confidence)))
		total, support, confidence = pattern.estimate(jcfeature.MU_SAMPLE_CLASS, jcfeature.scc_counted_support)
	...
	def __write_evaluation_all__(self, output: jcfeature.RIPMineOutput, patterns):
		...
		orig_samples, patt_samples, reduce, precision, recall, f1_score = RIPMineWriter.\
			__evaluate__(output, patterns, jcfeature.EX_SAMPLE_CLASS, jcfeature.unk_counted_support)
		self.__output__("\t{}\t{}\t{}\t{}\t{}\t{}\t{}\t{}\n".format("EXE", "UNK", orig_samples,
																	patt_samples, reduce, precision, recall, f1_score))
		orig_samples, patt_samples, reduce, precision, recall, f1_score = RIPMineWriter. \
			__evaluate__(output, patterns, jcfeature.EX_SAMPLE_CLASS, jcfeature.wcc_counted_support)
		self.__output__("\t{}\t{}\t{}\t{}\t{}\t{}\t{}\t{}\n".format("EXE", "WCC", orig_samples,
																	patt_samples, reduce, precision, recall, f1_score))
		orig_samples, patt_samples, reduce, precision, recall, f1_score = RIPMineWriter. \
			__evaluate__(output, patterns, jcfeature.EX_SAMPLE_CLASS, jcfeature.scc_counted_support)
		self.__output__("\t{}\t{}\t{}\t{}\t{}\t{}\t{}\t{}\n".format("EXE", "SCC", orig_samples,
																	patt_samples, reduce, precision, recall, f1_score))
		# SQ_SAMPLE_CLASS
		orig_samples, patt_samples, reduce, precision, recall, f1_score = RIPMineWriter. \
			__evaluate__(output, patterns, jcfeature.SQ_SAMPLE_CLASS, jcfeature.unk_counted_support)
		self.__output__("\t{}\t{}\t{}\t{}\t{}\t{}\t{}\t{}\n".format("SEQ", "UNK", orig_samples,
																	patt_samples, reduce, precision, recall, f1_score))
		orig_samples, patt_samples, reduce, precision, recall, f1_score = RIPMineWriter. \
			__evaluate__(output, patterns, jcfeature.SQ_SAMPLE_CLASS, jcfeature.wcc_counted_support)
		self.__output__("\t{}\t{}\t{}\t{}\t{}\t{}\t{}\t{}\n".format("SEQ", "WCC", orig_samples,
																	patt_samples, reduce, precision, recall, f1_score))
		orig_samples, patt_samples, reduce, precision, recall, f1_score = RIPMineWriter. \
			__evaluate__(output, patterns, jcfeature.SQ_SAMPLE_CLASS, jcfeature.scc_counted_support)
		self.__output__("\t{}\t{}\t{}\t{}\t{}\t{}\t{}\t{}\n".format("SEQ", "SCC", orig_samples,
																	patt_samples, reduce, precision, recall, f1_score))
		# MU_SAMPLE_CLASS
		orig_samples, patt_samples, reduce, precision, recall, f1_score = RIPMineWriter. \
			__evaluate__(output, patterns, jcfeature.MU_SAMPLE_CLASS, jcfeature.unk_counted_support)
		self.__output__("\t{}\t{}\t{}\t{}\t{}\t{}\t{}\t{}\n".format("MUT", "UNK", orig_samples,
																	patt_samples, reduce, precision, recall, f1_score))
		orig_samples, patt_samples, reduce, precision, recall, f1_score = RIPMineWriter. \
			__evaluate__(output, patterns, jcfeature.MU_SAMPLE_CLASS, jcfeature.wcc_counted_support)
		self.__output__("\t{}\t{}\t{}\t{}\t{}\t{}\t{}\t{}\n".format("MUT", "WCC", orig_samples,
																	patt_samples, reduce, precision, recall, f1_score))
		orig_samples, patt_samples, reduce, precision, recall, f1_score = RIPMineWriter. \
			__evaluate__(output, patterns, jcfeature.MU_SAMPLE_CLASS, jcfeature.scc_counted_support)
	...
	def write_to(self, output: jcfeature.RIPMineOutput, directory: str):
		...
		self.__write_best_patterns__(output.get_best_patterns(jcfeature.SQ_SAMPLE_CLASS, jcfeature.unk_counted_support),
...
def get_model_directory_name(model_name: str, sample_class, support_class):
	...
	if sample_class is None:
		...
		sample_class = "seq"
	if support_class == jcfeature.unk_counted_support:
		support_strategy = "unk"
	elif support_class == jcfeature.wcc_counted_support:
		support_strategy = "wcc"
	elif support_class == jcfeature.scc_counted_support:
		support_strategy = "scc"
	elif support_class == jcfeature.kid_counted_support:
...
def do_mining_on_classes(document: jctest.CDocument, output_directory: str, model_name: str,
	...
	:return:
	"""
	do_mining(document, output_directory, model_name, jcfeature.MU_SAMPLE_CLASS, jcfeature.unk_counted_support,
			  used_tests, max_length, min_support, min_confidence, max_confidence, do_model_mining)
	do_mining(document, output_directory, model_name, jcfeature.MU_SAMPLE_CLASS, jcfeature.wcc_counted_support,
			  used_tests, max_length, min_support, min_confidence, max_confidence, do_model_mining)
	do_mining(document, output_directory, model_name, jcfeature.MU_SAMPLE_CLASS, jcfeature.scc_counted_support,
			  used_tests, max_length, min_support, min_confidence, max_confidence, do_model_mining)
	do_mining(document, output_directory, model_name, jcfeature.SQ_SAMPLE_CLASS, jcfeature.unk_counted_support,
			  used_tests, max_length, min_support, min_confidence, max_confidence, do_model_mining)
	do_mining(document, output_directory, model_name, jcfeature.SQ_SAMPLE_CLASS, jcfeature.wcc_counted_support,
			  used_tests, max_length, min_support, min_confidence, max_confidence, do_model_mining)
	do_mining(document, output_directory, model_name, jcfeature.SQ_SAMPLE_CLASS, jcfeature.scc_counted_support,
			  used_tests, max_length, min_support, min_confidence, max_confidence, do_model_mining)
	return
