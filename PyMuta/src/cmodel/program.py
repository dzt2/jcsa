...
class Program:
    ...
    def __init__(self, dir_path: str):
        ...
        ins_file = os.path.join(dir_path, self.name + '.ins')
        dep_file = os.path.join(dir_path, self.name + '.dep')
        cal_file = os.path.join(dir_path, self.name + '.cal')
        ...
        self.function_graph = cflow.CirFunctionGraph(self, flw_file, cal_file)
        self.instance_graph = cflow.CirInstanceGraph(self, ins_file)
        self.dependence_graph = cflow.CDependenceGraph(self, dep_file)
