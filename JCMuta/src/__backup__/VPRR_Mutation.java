...
public class VPRR_Mutation extends CustomizeMutation {

	protected VPRR_Mutation(AstExpression source, AstName argument) throws Exception {
		super(MutOperator.VPRR, MutationMode.REF_TOT_REF, source, argument);
	}
	...
	protected boolean validate(MutationMode mode, AstNode source, Object argument) {
		...
		if(JC_Classifier.is_access_path(origins)) {
			...
			if(type1 instanceof CPointerType
					&& type2 instanceof CPointerType) {
