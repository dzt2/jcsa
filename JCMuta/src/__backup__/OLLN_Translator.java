...
public class OLLN_Translator extends MutTranslator {

	@Override
	protected boolean validate(Mutation mutation) {
		return mutation instanceof OLLN_Mutation;
	}
	@Override
	...
	protected void mutate(Mutation mutation) throws Exception {
		...
		case LAN_LOR: buffer.append("||"); break;
		case LOR_LAN: buffer.append("&&"); break;
