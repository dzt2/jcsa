...
public class LSHXMutationParser extends OXXNMutationParser {
	...
	protected void generate_infections(AstMutation ast_mutation, CirExpression expression, CirExpression loperand,
		...
		case bitws_lsh_to_arith_add: this.bitws_lsh_to_arith_add(expression, loperand, roperand, lvalue, rvalue); break;
		case bitws_lsh_to_arith_sub: this.bitws_lsh_to_arith_sub(expression, loperand, roperand, lvalue, rvalue); break;
		case bitws_lsh_to_arith_mul: this.bitws_lsh_to_arith_mul(expression, loperand, roperand, lvalue, rvalue); break;
		case bitws_lsh_to_arith_div: this.bitws_lsh_to_arith_div(expression, loperand, roperand, lvalue, rvalue); break;
		case bitws_lsh_to_arith_mod: this.bitws_lsh_to_arith_mod(expression, loperand, roperand, lvalue, rvalue); break;
		case bitws_lsh_to_bitws_and: this.bitws_lsh_to_bitws_and(expression, loperand, roperand, lvalue, rvalue); break;
		case bitws_lsh_to_bitws_ior: this.bitws_lsh_to_bitws_ior(expression, loperand, roperand, lvalue, rvalue); break;
		case bitws_lsh_to_bitws_xor: this.bitws_lsh_to_bitws_xor(expression, loperand, roperand, lvalue, rvalue); break;
		case bitws_lsh_to_bitws_rsh: this.bitws_lsh_to_bitws_rsh(expression, loperand, roperand, lvalue, rvalue); break;
		case bitws_lsh_to_logic_and: this.bitws_lsh_to_logic_and(expression, loperand, roperand, lvalue, rvalue); break;
		case bitws_lsh_to_logic_ior: this.bitws_lsh_to_logic_ior(expression, loperand, roperand, lvalue, rvalue); break;
		case bitws_lsh_to_greater_tn: this.bitws_lsh_to_greater_tn(expression, loperand, roperand, lvalue, rvalue); break;
		case bitws_lsh_to_greater_eq: this.bitws_lsh_to_greater_eq(expression, loperand, roperand, lvalue, rvalue); break;
		case bitws_lsh_to_smaller_tn: this.bitws_lsh_to_smaller_tn(expression, loperand, roperand, lvalue, rvalue); break;
		case bitws_lsh_to_smaller_eq: this.bitws_lsh_to_smaller_eq(expression, loperand, roperand, lvalue, rvalue); break;
		case bitws_lsh_to_equal_with: this.bitws_lsh_to_equal_with(expression, loperand, roperand, lvalue, rvalue); break;
		case bitws_lsh_to_not_equals: this.bitws_lsh_to_not_equals(expression, loperand, roperand, lvalue, rvalue); break;
	...
	private void bitws_lsh_to_logic_and(CirExpression expression, CirExpression loperand,
			CirExpression roperand, Object lvalue, Object rvalue) throws Exception {
		if(lvalue != null && rvalue != null) {
			this.compute_const_to_const(expression, COperator.
					left_shift, loperand, roperand, COperator.logic_and);
		}
		else {
	...
	private void bitws_lsh_to_logic_ior(CirExpression expression, CirExpression loperand,
			CirExpression roperand, Object lvalue, Object rvalue) throws Exception {
		if(lvalue != null && rvalue != null) {
			this.compute_const_to_const(expression, COperator.
					left_shift, loperand, roperand, COperator.logic_or);
		}
		else {
	...
	private void bitws_lsh_to_greater_tn(CirExpression expression, CirExpression loperand,
			CirExpression roperand, Object lvalue, Object rvalue) throws Exception {
		if(lvalue != null && rvalue != null) {
			this.compute_const_to_const(expression, COperator.
					left_shift, loperand, roperand, COperator.greater_tn);
		}
		else {
	...
	private void bitws_lsh_to_greater_eq(CirExpression expression, CirExpression loperand,
			CirExpression roperand, Object lvalue, Object rvalue) throws Exception {
		if(lvalue != null && rvalue != null) {
			this.compute_const_to_const(expression, COperator.
					left_shift, loperand, roperand, COperator.greater_eq);
		}
		else {
			SemanticAssertion error2, error3, error4, error5, error6;
			error2 = sem_mutation.get_assertions().set_value(expression, 0);
	...
	private void bitws_lsh_to_smaller_tn(CirExpression expression, CirExpression loperand,
			CirExpression roperand, Object lvalue, Object rvalue) throws Exception {
		if(lvalue != null && rvalue != null) {
			this.compute_const_to_const(expression, COperator.
					left_shift, loperand, roperand, COperator.smaller_tn);
		}
		else {
			SemanticAssertion error2, error3, error4, error5, error6;
			error2 = sem_mutation.get_assertions().set_value(expression, 0);
	...
	private void bitws_lsh_to_smaller_eq(CirExpression expression, CirExpression loperand,
			CirExpression roperand, Object lvalue, Object rvalue) throws Exception {
		if(lvalue != null && rvalue != null) {
			this.compute_const_to_const(expression, COperator.
					left_shift, loperand, roperand, COperator.smaller_eq);
		}
		else {
			SemanticAssertion error2, error3, error4, error5, error6;
			error2 = sem_mutation.get_assertions().set_value(expression, 0);
	...
	private void bitws_lsh_to_equal_with(CirExpression expression, CirExpression loperand,
			CirExpression roperand, Object lvalue, Object rvalue) throws Exception {
		if(lvalue != null && rvalue != null) {
			this.compute_const_to_const(expression, COperator.
					left_shift, loperand, roperand, COperator.equal_with);
		}
		else {
	...
	private void bitws_lsh_to_not_equals(CirExpression expression, CirExpression loperand,
			CirExpression roperand, Object lvalue, Object rvalue) throws Exception {
		if(lvalue != null && rvalue != null) {
			this.compute_const_to_const(expression, COperator.
					left_shift, loperand, roperand, COperator.not_equals);
		}
		else {
			SemanticAssertion error2, error3, error4, error5, error6;
			error2 = sem_mutation.get_assertions().set_value(expression, 0);
