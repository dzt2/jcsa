...
public class ConstraintExtension {
	...
	private SemanticConstraint extend(Iterable<SemanticAssertion> assertions) throws Exception {
		...
		return new SemanticConstraint(this.extension_set);
	}
	/**
	 ...
	 * @throws Exception
	 */
	public static SemanticConstraint get_constraint(CirTree cir_tree, CirInstanceGraph instance_graph, 
