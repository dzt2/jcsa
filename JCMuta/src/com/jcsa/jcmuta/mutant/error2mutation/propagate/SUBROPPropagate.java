...
public class SUBROPPropagate extends StatePropagate {
	...
	protected void propagate_set_numb(StateError error, CirNode cir_target, StateErrorGraph graph,
		...
		Object loperand = StateEvaluation.get_constant_value(expression.get_operand(1));
		if(!(loperand instanceof SymExpression)) {
			Object result = this.arith_sub(loperand, roperand);
