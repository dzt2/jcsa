...
/**
 * lcondition and !rcondition or !lcondition and rcondition
 * @author yukimula
 *
 */
public class LANLORInfection extends OPRTInfection {

	@Override
	protected SymExpression muta_expression(CirExpression expression, CirExpression loperand, CirExpression roperand)
			throws Exception {
		return StateEvaluation.binary_expression(CBasicTypeImpl.
				bool_type, COperator.logic_or, loperand, roperand);
	}
