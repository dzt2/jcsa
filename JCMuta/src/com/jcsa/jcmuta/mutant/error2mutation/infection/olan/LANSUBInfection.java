 ...
 *
 */
public class LANSUBInfection extends OPRTInfection {
	...
	protected boolean symbolic_evaluate(CirExpression expression, CirExpression loperand, CirExpression roperand,
		...
		lcondition = StateEvaluation.logic_or(
				...
				StateEvaluation.new_condition(roperand, false));
		rcondition = StateEvaluation.logic_or(
				StateEvaluation.new_condition(loperand, false), 
