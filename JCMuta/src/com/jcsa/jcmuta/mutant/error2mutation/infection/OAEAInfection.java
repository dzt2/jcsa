...
public class OAEAInfection extends StateInfection {
	 ...
	 * @throws Exception
	 */
	private void arith_add_assign(CirExpression expression, CirExpression loperand, CirExpression roperand, 
	 ...
	 * @throws Exception
	 */
	private void arith_sub_assign(CirExpression expression, CirExpression loperand, CirExpression roperand, 
			StateErrorGraph graph, Map<StateError, StateConstraints> output) throws Exception {
		SymExpression condition = this.get_sym_condition(loperand, false);
		condition = this.derive_sym_constraint(condition);
		StateConstraints constraints = new StateConstraints(true);
	 ...
	 * @throws Exception
	 */
	private void arith_mul_assign(CirExpression expression, CirExpression loperand, CirExpression roperand, 
			StateErrorGraph graph, Map<StateError, StateConstraints> output) throws Exception {
	 ...
	 * @throws Exception
	 */
	private void arith_div_assign(CirExpression expression, CirExpression loperand, CirExpression roperand, 
			StateErrorGraph graph, Map<StateError, StateConstraints> output) throws Exception {
	 ...
	 * @throws Exception
	 */
	private void arith_mod_assign(CirExpression expression, CirExpression loperand, CirExpression roperand, 
			StateErrorGraph graph, Map<StateError, StateConstraints> output) throws Exception {
		StateConstraints constraints; SymExpression condition;
	...
	protected void get_infections(CirTree cir_tree, AstMutation mutation, StateErrorGraph graph,
		...
		case arith_add_assign_to_assign: this.arith_add_assign(expression, loperand, roperand, graph, output); break;
		case arith_sub_assign_to_assign: this.arith_sub_assign(expression, loperand, roperand, graph, output); break;
		case arith_mul_assign_to_assign: this.arith_mul_assign(expression, loperand, roperand, graph, output); break;
		case arith_div_assign_to_assign: this.arith_div_assign(expression, loperand, roperand, graph, output); break;
		case arith_mod_assign_to_assign: this.arith_mod_assign(expression, loperand, roperand, graph, output); break;
