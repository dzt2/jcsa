...
/**
 * roperand == 0		--> failure()
 * loperand == k * roperand and loperand > roperand	--> set_false()
 * loperand != k * roperand and loperand < roperand --> set_true()
 * @author yukimula
 *
 */
public class GREMODInfection extends OPRTInfection {
	...
	protected boolean symbolic_evaluate(CirExpression expression, CirExpression loperand, CirExpression roperand,
		...
		rcondition = StateEvaluation.greater_eq(loperand, roperand);
		constraints = StateEvaluation.get_conjunctions();
		this.add_constraint(constraints, statement, lcondition);
