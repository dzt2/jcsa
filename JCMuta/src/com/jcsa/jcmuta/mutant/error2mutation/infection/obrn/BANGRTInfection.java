 ...
 * loperand > roperand and roperand == 0 	--> dif_numb(1)
 * loperand > roperand						--> set_true
 * loperand <= roperand						--> set_false
 * @author yukimula
 *
 */
public class BANGRTInfection extends OPRTInfection {
	...
	protected boolean symbolic_evaluate(CirExpression expression, CirExpression loperand, CirExpression roperand,
		...
		lcondition = StateEvaluation.logic_and(StateEvaluation.equal_with
				(loperand, 0L), StateEvaluation.greater_tn(loperand, roperand));
		rcondition = StateEvaluation.logic_and(StateEvaluation.equal_with
				(roperand, 0L), StateEvaluation.greater_tn(loperand, roperand));
