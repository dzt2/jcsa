 ...
 *
 */
public class BORMODInfection extends OPRTInfection {
	...
	protected boolean symbolic_evaluate(CirExpression expression, CirExpression loperand, CirExpression roperand,
		...
		/** loperand == k * roperand --> set_numb(0) **/
		lcondition = StateEvaluation.multiply_expression(expression.get_data_type(), roperand);
		rcondition = StateEvaluation.equal_with(StateEvaluation.get_symbol(loperand), lcondition);
