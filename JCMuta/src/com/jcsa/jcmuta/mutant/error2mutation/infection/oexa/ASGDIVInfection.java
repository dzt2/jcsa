...
public class ASGDIVInfection extends OPRTInfection {
	...
	protected boolean symbolic_evaluate(CirExpression expression, CirExpression loperand, CirExpression roperand,
		...
		constraint = StateEvaluation.not_equals(StateEvaluation.get_symbol(loperand), 
				StateEvaluation.binary_expression(roperand.get_data_type(), 
						COperator.arith_mul, roperand, roperand));
		constraints = StateEvaluation.get_conjunctions();
		this.add_constraint(constraints, statement, constraint);
