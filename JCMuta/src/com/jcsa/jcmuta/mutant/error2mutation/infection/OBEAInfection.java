...
public class OBEAInfection extends StateInfection {
	 ...
	 * @throws Exception
	 */
	private void bitws_and_assign(CirExpression expression, CirExpression loperand, CirExpression roperand, 
	 ...
	 * @throws Exception
	 */
	private void bitws_ior_assign(CirExpression expression, CirExpression loperand, CirExpression roperand, 
			StateErrorGraph graph, Map<StateError, StateConstraints> output) throws Exception {	
	 ...
	 * @throws Exception
	 */
	private void bitws_xor_assign(CirExpression expression, CirExpression loperand, CirExpression roperand, 
			StateErrorGraph graph, Map<StateError, StateConstraints> output) throws Exception {	
	 ...
	 * @throws Exception
	 */
	private void bitws_lsh_assign(CirExpression expression, CirExpression loperand, CirExpression roperand, 
			StateErrorGraph graph, Map<StateError, StateConstraints> output) throws Exception {	
		SymExpression condition = SymFactory.parse(loperand);
		condition = SymFactory.new_binary_expression(CBasicTypeImpl.bool_type, 
				COperator.not_equals, condition, SymFactory.new_constant(0L));
	 ...
	 * @throws Exception
	 */
	private void bitws_rsh_assign(CirExpression expression, CirExpression loperand, CirExpression roperand, 
			StateErrorGraph graph, Map<StateError, StateConstraints> output) throws Exception {	
		SymExpression condition = SymFactory.parse(loperand);
		condition = SymFactory.new_binary_expression(CBasicTypeImpl.bool_type, 
				COperator.not_equals, condition, SymFactory.new_constant(0L));
	...
	protected void get_infections(CirTree cir_tree, AstMutation mutation, StateErrorGraph graph,
		...
		case assign_to_bitws_and_assign: this.bitws_and_assign(expression, loperand, roperand, graph, output); break;
		case assign_to_bitws_ior_assign: this.bitws_ior_assign(expression, loperand, roperand, graph, output); break;
		case assign_to_bitws_xor_assign: this.bitws_xor_assign(expression, loperand, roperand, graph, output); break;
		case assign_to_bitws_lsh_assign: this.bitws_lsh_assign(expression, loperand, roperand, graph, output); break;
		case assign_to_bitws_rsh_assign: this.bitws_rsh_assign(expression, loperand, roperand, graph, output); break;
