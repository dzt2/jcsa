...
public class CirDeclaratorReferenceImpl extends CirExpressionImpl implements CirDeclaratorReference {
	
	private String name;
	private int scope_id;
	
	protected CirDeclaratorReferenceImpl(CirTree tree, 
	...
	protected CirNode copy_self() {
		return new CirDeclaratorReferenceImpl(this.get_tree(), 
