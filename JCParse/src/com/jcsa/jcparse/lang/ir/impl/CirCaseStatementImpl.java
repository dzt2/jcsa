...
import com.jcsa.jcparse.lang.ir.stmt.transit.CirCaseStatement;
import com.jcsa.jcparse.lang.ir.unit.CirLabel;

public class CirCaseStatementImpl extends CirStatementImpl implements CirCaseStatement {

	protected CirCaseStatementImpl(CirTree tree) {
		super(tree);
	}
	...
	protected CirNode copy_self() {
		return new CirCaseStatementImpl(this.get_tree());
	}
