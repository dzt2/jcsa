...
import com.jcsa.jcparse.lang.ir.stmt.assign.CirInitialAssignStatement;

public class CirInitialAssignStatementImpl extends CirStatementImpl implements CirInitialAssignStatement {

	protected CirInitialAssignStatementImpl(CirTree tree) {
		super(tree);
	}
	...
	protected CirNode copy_self() {
		return new CirInitialAssignStatementImpl(this.get_tree());
	}
