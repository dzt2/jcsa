...
import com.jcsa.jcparse.lang.ir.stmt.assign.CirWaitAssignStatement;

public class CirWaitAssignStatementImpl extends CirStatementImpl implements CirWaitAssignStatement {

	protected CirWaitAssignStatementImpl(CirTree tree) {
		super(tree);
	}
	...
	protected CirNode copy_self() {
		return new CirWaitAssignStatementImpl(this.get_tree());
	}
