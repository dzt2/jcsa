 ...
 * github:      https://github.com/rg3/sudoku 
 * 
 * Usage:   
 *  [1] read from standard input
 *  [2] read from a text file
 * Input:
 *  A sequence of characters, in which 1-9 for known number; '.' for unknown.
 ********************************************************************************/
...
int square(int row, int col) 
{
	...
	return (((row - 1) / SUBDIMENSION) * SUBDIMENSION) + ((col - 1) / SUBDIMENSION) + 1;
}
...
int main(int argc, char *argv[]) 
{
    ...
    {
    	fprintf(stderr, "Congratulation! The board is solvable!\n");
    }
